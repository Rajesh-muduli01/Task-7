...
export interface ApiAgentAgent extends Schema.SingleType {
  ...
  attributes: {
    ...
    SocialMediaLinks: Attribute.UID;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiHeroTitleHeroTitle extends Schema.SingleType {
  collectionName: 'hero_titles';
  info: {
    singularName: 'hero-title';
    pluralName: 'hero-titles';
    displayName: 'Fields';
    description: '';
  };
  options: {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::hero-title.hero-title': ApiHeroTitleHeroTitle;
